...
import nbc.subjectbaro.domain.common.exception.ExceptionResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleCustomException(
        ...
        return ResponseEntity
            ...
            .body(ExceptionResponse.from(e.getCode(), e.getMessage()));
    }
    ...
    public ResponseEntity<ExceptionResponse> handleException(
        ...
        return ResponseEntity
            .internalServerError()
            .body(ExceptionResponse.from("SERVER_ERROR", "서버가 응답할 수 없습니다."));
    }
    ...
    public ResponseEntity<ExceptionResponse> handleMethodArgumentNotValid(
        ...
        return ResponseEntity
            .badRequest()
            .body(ExceptionResponse.from("BODY_INVALID", errorMessage));
    }
    ...
    public ResponseEntity<ExceptionResponse> handleMissingServletRequestParameterException(
        ...
        return ResponseEntity
            .badRequest()
            .body(ExceptionResponse.from("PARAMETER_NULL", errorMessage));
    }
    ...
    public ResponseEntity<ExceptionResponse> handleMethodArgumentTypeMismatch(
        ...
        return ResponseEntity
            .badRequest()
            .body(ExceptionResponse.from("PARAMETER_INVALID", errorMessage));
    }
    ...
    public ResponseEntity<ExceptionResponse> handleHttpMessageNotReadable(
        ...
        return ResponseEntity
            .badRequest()
            .body(ExceptionResponse.from("HTTP_MESSAGE_INVALID", "요청 메시지가 유효하지 않습니다."));
    }
}
